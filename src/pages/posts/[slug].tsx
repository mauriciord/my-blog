...
export default function Post({ post, redirect, preview }) {
  const router = useRouter();
  const urlToShare = `${metaData.url}/posts/${post?.Slug}`;
  const titleToShare = `${post?.Page} by Mauricio R. Duarte<@mauriciord>`;
  ...
  console.log('Post ________', { post, urlToShare, titleToShare });
                          ...
                          >
                            ...
                            <div className={blogStyles.bookmarkCoverWrapper1}>
                              <div className={blogStyles.bookmarkCoverWrapper2}>
                                <div
                                  className={blogStyles.bookmarkCoverWrapper3}
                                >
                                  <img
                                    src={cover}
